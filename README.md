...
AI_project_1/
  ...
  model_architecture.png  # Generated model diagram (tf.keras.utils.plot_model)
  training_curves.png     # Generated: train/val loss per epoch
  prediction_vs_actual.png # Generated: predicted vs. actual returns (validation set)
  large_errors.png        # Generated: table of the 15 largest prediction misses
  results_table.png       # Generated: model vs. baselines — MSE + directional accuracy
  fk_comparison.png       # Generated: long/short backtest vs. Fischer & Krauss (2018)
  capacity_ablation.png   # Generated: model size vs. validation loss bar chart
  system_diagram.png      # Generated: data-to-product deployment flow diagram
...
- [ ] Step 19: Presentation slide deck
...
| File | Shows |
|------|-------|
| `training_curves.png` | Train vs. validation loss per epoch, read directly from existing TensorBoard logs |
| `prediction_vs_actual.png` | Scatter plot of predicted vs. actual next-day returns on the validation set |
| `large_errors.png` | Table of the 15 largest prediction misses (ticker, date, predicted, actual) |
| `results_table.png` | Model vs. baselines table — MSE + directional accuracy, computed live against the saved model |
| `fk_comparison.png` | Long/short backtest (top/bottom 10 stocks daily) vs. Fischer & Krauss (2018) published benchmark |
| `capacity_ablation.png` | Bar chart: validation loss across 4 model sizes (3K–75K params) — visual for the capacity ablation finding |
